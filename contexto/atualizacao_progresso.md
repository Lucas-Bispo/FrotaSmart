...
Sempre antes de encerrar uma solucao ou bloco de codigo, gere um topico chamado `### Status de Progresso`.

Nesse topico, liste:
- Concluido: o que acabou de ser implementado
- Pendente: o proximo passo logico ou funcionalidades que faltam
- Debito tecnico: erros conhecidos ou otimizacoes necessarias
